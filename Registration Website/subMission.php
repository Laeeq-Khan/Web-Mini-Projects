...
if(isset($_POST['submit'])){
      ...
      $shadi = hackingValidation($_POST['shadi']);
    ...
    echo $img;
    $query = "INSERT INTO registered(cnic , fullname , fathername , dob , contact , email , gender , shadi , board1, rollno1 , year1 , group1, ";
   $query  .= " obtain1 ,total1 , board2  , rollno2 , year2, group2, obtain2 , total2, program  , discipline  ,	Image ) ";
    $query .= "VALUES('$cnic', '$fullName' , '$fatherName','$dob' ,'$contact','$email','$gender','$shadi','$board1','$roll1','$year1' , ";
...
<div class="col-md-12" style="background-color:green; padding:40px;">
    ...
    <h1 style="color:yellow; text-align:center;"> Congrats you are successfully Registerd </h1>
    <h4 style="color:yellow ; text-align:center"> Your Siral No :  
        <?php 
